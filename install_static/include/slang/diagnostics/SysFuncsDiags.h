...
inline constexpr DiagCode SequenceMethodLocalVar(DiagSubsystem::SysFuncs, 37);
inline constexpr DiagCode SysFuncHierarchicalNotAllowed(DiagSubsystem::SysFuncs, 38);
inline constexpr DiagCode SysFuncNotConst(DiagSubsystem::SysFuncs, 39);
inline constexpr DiagCode TypeIsNotAClass(DiagSubsystem::SysFuncs, 40);
inline constexpr DiagCode UnknownFormatSpecifier(DiagSubsystem::SysFuncs, 41);
inline constexpr DiagCode BadFinishNum(DiagSubsystem::SysFuncs, 42);
inline constexpr DiagCode FormatMultibitStrength(DiagSubsystem::SysFuncs, 43);
inline constexpr DiagCode FormatRealInt(DiagSubsystem::SysFuncs, 44);
inline constexpr DiagCode IsUnboundedParamArg(DiagSubsystem::SysFuncs, 45);
inline constexpr DiagCode MissingFormatSpecifier(DiagSubsystem::SysFuncs, 46);
inline constexpr DiagCode NonstandardSysFunc(DiagSubsystem::SysFuncs, 47);

...
enum class SLANG_EXPORT TriviaKind : uint8_t {
    Unknown,
    Whitespace,
    EndOfLine,
    LineComment,
...
SLANG_EXPORT std::ostream& operator<<(std::ostream& os, TriviaKind kind);
SLANG_EXPORT std::string_view toString(TriviaKind kind);

class SLANG_EXPORT TriviaKind_traits {
public:
    static const std::array<TriviaKind, 9> values;
};
...
SLANG_EXPORT std::ostream& operator<<(std::ostream& os, TokenKind kind);
SLANG_EXPORT std::string_view toString(TokenKind kind);

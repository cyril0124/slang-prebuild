...
inline constexpr DiagCode MultipleNetAlias(DiagSubsystem::Compilation, 26);
inline constexpr DiagCode MultipleTopDupName(DiagSubsystem::Compilation, 27);
inline constexpr DiagCode NestedConfigMultipleTops(DiagSubsystem::Compilation, 28);
inline constexpr DiagCode NetAliasSelf(DiagSubsystem::Compilation, 29);
inline constexpr DiagCode NoDeclInClass(DiagSubsystem::Compilation, 30);
inline constexpr DiagCode TopModuleIfacePort(DiagSubsystem::Compilation, 31);
inline constexpr DiagCode TopModuleRefPort(DiagSubsystem::Compilation, 32);
inline constexpr DiagCode TopModuleUnnamedRefPort(DiagSubsystem::Compilation, 33);
inline constexpr DiagCode UnknownLibrary(DiagSubsystem::Compilation, 34);
inline constexpr DiagCode VirtualIfaceHierRef(DiagSubsystem::Compilation, 35);
inline constexpr DiagCode VirtualIfaceIfacePort(DiagSubsystem::Compilation, 36);
inline constexpr DiagCode WrongBindTargetDef(DiagSubsystem::Compilation, 37);
...
inline constexpr DiagCode UnassignedVariable(DiagSubsystem::Compilation, 43);
inline constexpr DiagCode UndrivenNet(DiagSubsystem::Compilation, 44);
inline constexpr DiagCode UndrivenPort(DiagSubsystem::Compilation, 45);
inline constexpr DiagCode UnusedArgument(DiagSubsystem::Compilation, 46);
inline constexpr DiagCode UnusedAssertionDecl(DiagSubsystem::Compilation, 47);
inline constexpr DiagCode UnusedButSetNet(DiagSubsystem::Compilation, 48);
inline constexpr DiagCode UnusedButSetPort(DiagSubsystem::Compilation, 49);
inline constexpr DiagCode UnusedButSetVariable(DiagSubsystem::Compilation, 50);
inline constexpr DiagCode UnusedDefinition(DiagSubsystem::Compilation, 51);
inline constexpr DiagCode UnusedGenvar(DiagSubsystem::Compilation, 52);
inline constexpr DiagCode UnusedImplicitNet(DiagSubsystem::Compilation, 53);
inline constexpr DiagCode UnusedImport(DiagSubsystem::Compilation, 54);
inline constexpr DiagCode UnusedNet(DiagSubsystem::Compilation, 55);
inline constexpr DiagCode UnusedParameter(DiagSubsystem::Compilation, 56);
inline constexpr DiagCode UnusedPort(DiagSubsystem::Compilation, 57);
inline constexpr DiagCode UnusedTypeParameter(DiagSubsystem::Compilation, 58);
inline constexpr DiagCode UnusedTypedef(DiagSubsystem::Compilation, 59);
inline constexpr DiagCode UnusedVariable(DiagSubsystem::Compilation, 60);
inline constexpr DiagCode UnusedWildcardImport(DiagSubsystem::Compilation, 61);
